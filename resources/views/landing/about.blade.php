...
<main id="main">
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="{{ $courseCount }}" data-purecounter-duration="0" class="purecounter">64</span>
            <p>Courses</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="{{ $eventCount }}" data-purecounter-duration="0" class="purecounter">42</span>
            <p>Events</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="{{ $trainerCount }}" data-purecounter-duration="0" class="purecounter">15</span>
            <p>Trainers</p>
          </div>
    ...
    <section id="testimonials" class="testimonials">
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        @php $count = $testimonials->count(); @endphp
        ...
        <div class="testimonials-slider swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="swiper-wrapper" id="swiper-wrapper-109be50b296a1b9ac" aria-live="off" style="transform: translate3d(-2148px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate" role="group" aria-label="5 / 5" data-swiper-slide-index="4" style="width: 696px; margin-right: 20px;">
            ...
            <div class="swiper-slide" role="group" aria-label="{{ ++$key }} / {{ $count }}" data-swiper-slide-index="0" style="width: 696px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ $item->photo }}" class="testimonial-img" alt="">
                  <h3>{{ $item->name }}</h3>
...
{{-- 
             <div class="swiper-slide swiper-slide-prev" role="group" aria-label="2 / 5" data-swiper-slide-index="1" style="width: 696px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
            ...
            <div class="swiper-slide swiper-slide-active" role="group" aria-label="3 / 5" data-swiper-slide-index="2" style="width: 696px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
